     ...
     <x-web.tableRow options="true" extra="true">
      ...
      <x-slot name="tableData">
       ...
       @can('permissions.update')
           <td data-label="Fecha" class=" before:content-[attr(data-label)] text-left  before:mb-2  sm:before:content-none px-0 py-3 sm:table-cell block before:block before:font-semibold"><a href="{{route('users.editRoles',$user->id)}}" type="button" class="px-3 py-2 text-sm font-medium text-center text-white bg-sc_greeny rounded-lg hover:bg-sc_greener focus:ring-4 focus:outline-none hover:cursor-pointer">Editar</a></td>
        @endcan
