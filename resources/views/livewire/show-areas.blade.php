<x-web.container title="Departamentos" search="true" actions="true" filters="true" add="true">
 ...
 <x-slot name="Table">
  <x-web.table headers="Abreviatura|Nombre|Encargado de área|Teléfono|Dirección">
   <x-slot name="data">
    @foreach ($areas as $area)
     <x-web.tableRow options="true">
      ...
      <x-slot name="tableData">
       ...
       <x-web.tableData label='Dirección'>{{ $area->address }}</x-web.tableData>
      </x-slot>
 ...
 <x-slot name="Modal">
  <x-web.createModal-lg createmodalId="createModal" title="Agregar área" permission="areas.store">
   <x-slot name="form">
