<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <h2 class="text-lg pt-4 pl-4 font-medium text-gray-900 dark:text-white">Roles</h2>
       ...
       <div class="overflow-x-auto">
        <table class="w-full table-fixed text-sm text-left text-gray-500 dark:text-gray-400">
         <thead class=" uppercase text-gray-800 bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
          <tr>
           <th scope="col" class="hidden sm:table-cell px-4 py-3 w-1/12">Id</th>
           <th scope="col" class="hidden sm:table-cell px-4 py-3 w-10/12">Nombre</th>

           <th scope="col" class="hidden sm:table-cell px-2 py-3 w-1/12">
         ...
         <tbody>
          ...
          <tr class="border-b text-sm text-gray-900 font-medium">
           <td data-label="Nombre de documento" scope="row" class=" before:content-[attr(data-label)] text-left  before:mb-2  sm:before:content-none px-4 py-3 sm:table-cell block before:block before:font-semibold" >{{$role->id}}</td>
           <td data-label="Nombre de documento" scope="row" class=" before:content-[attr(data-label)] text-left  before:mb-2  sm:before:content-none px-4 py-3 sm:table-cell block before:block before:font-semibold" >{{$role->name}}</td>


           <td class="px-4 py-3 flex items-center justify-end">
            <button data-modal-toggle="showModal{{$role->id}}"
            ...
            <div id="showModal{{$role->id}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
               <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                   ...
                   <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                           ...
                           <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                               ...
                               <div>
                                   <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="showModal{{$role->id}}">
                                       <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                           ...
                           <dl>
                               <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Permisos asignados</dt>
                               @foreach ($role->permissions as $per)
                               <dd class=" font-light text-gray-500 dark:text-gray-400">{{__($per->name)}}</dd>
