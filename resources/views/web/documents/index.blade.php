        ...
        <div class="overflow-x-auto">
         <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead class=" uppercase text-gray-800 bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
           <tr>
            <th scope="col" class="px-4 py-3">Nombre de documento</th>
            ...
            <th scope="col" class="px-4 py-3">Área asignada</th>
          ...
          <tbody>
           ...
           <tr class="border-b text-sm text-gray-900 font-medium">
            <td id="12" data-label="Nombre de documento" scope="row" class=" before:content-[attr(data-label)] text-left  before:mb-5  sm:before:content-none px-4 py-3 text-xs sm:table-cell block before:block" >{{$doc->name}}</td>
            <td data-label="Tipo de documento" class=" before:content-[attr(data-label)] text-left  before:mb-5  sm:before:content-none  px-4 py-3 sm:table-cell block before:block">{{$doc->doc_type->name}}</td>
            <td data-label="Fecha" class=" before:content-[attr(data-label)] text-left  before:mb-5  sm:before:content-none px-4 py-3 sm:table-cell block before:block">{{$doc->date}}</td>
            <td data-label="Número" class=" before:content-[attr(data-label)] text-left  before:mb-5   sm:before:content-none px-4 py-3 sm:table-cell block before:block">{{$doc->number}}</td>
            <td data-label="Remitente" class=" before:content-[attr(data-label)] text-left  before:mb-5   sm:before:content-none px-4 py-3 sm:table-cell block before:block">{{$doc->sender}}</td>
            <td data-label="Asunto" class=" before:content-[attr(data-label)] text-left  before:mb-5   sm:before:content-none px-4 py-3 sm:table-cell block before:block">{{$doc->subject}}</td>
            <td data-label="Área asignada" class=" before:content-[attr(data-label)] text-left  before:mb-5 sm:before:content-none px-4 py-3 sm:table-cell block before:block">{{$doc->area->name}}</td>
            <td data-label="Documento" class=" before:content-[attr(data-label)] text-left  before:mb-5  sm:before:content-none px-4 py-3 sm:table-cell block before:block" align="center"><a href="{{asset('storage/documents/'.$doc->document)}}" target="_BLANK">
            ...
            <td class="px-4 py-3 flex items-center justify-end">
             <button id="apple-imac-27-dropdown-button" data-modal-toggle="apple-imac-27-dropdown"
