  ...
  <div class="py-4 mt-14">
   ...
   <div class="mx-auto max-w-screen-xl px-4">
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
      <h2 class="text-lg pt-4 pl-4 font-medium text-gray-900 dark:text-white">Entradas</h2>
     <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
      ...
      <div
       ...
       <button type="button" 
        class="flex items-center justify-center text-white bg-sc_green hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
